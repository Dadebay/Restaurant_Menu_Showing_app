...
class MyTranslations extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        'tm': {
          ...
          'yes': 'Hawwa',
          'start_view1': 'MENU',
          'start_view2': 'SAZLAMALAR',
          'start_view3': 'BIZ BARADA',
          'add_category': 'Kategoriýa goş',
          'add_product': 'Haryt goş',
          'add_category_first': 'Kategoriýa goşuň',
          'add_banner': 'Reklama goş',
          'no_image_selected': 'Surat saýlamadyňyz',
          'category_name': 'Kategoriýa ady',
          'select_image': "Surat saýla",
          'category_added': "Kategoriýa goşuldy",
          'product_added': "Haryt goşuldy",
          'banner_added': "Reklama goşuldy",
          'deleted': 'Pozuldy',
          'category_deleted': 'Kategoriýa pozuldy',
          'banner_deleted': "Reklama pozuldy",
          'log_out_title': 'Siz hakykatdanda ulgamdan çykmak isleýärsiňizmi ?',
          'log_out_subtitle': 'Siz hakykatdan hem programmadan çykmak isleýärsiňizmi ?',
          'service_for': 'Hyzmat üçin :',
          'doYouWantToDeleteCart': 'Sebedi boşat !',
          'doYouWantToDeleteCartSubtitle': 'Siz hakykatdanam Sebedi boşatmakçymy ?',
          'select_category': 'Kategoriýa saýla',
          'product_name': 'Haryt ady',
          'product_price': 'Haryt bahasy TMT',
          'add_product': "Haryt goşmak",
          'description': 'Beýany',
          'cartEmpty': "Sebediňiz boş",
          'cartEmptySubtitle': "Sebediňize hiç zat goşmadyňyz.",
          'ordersDeleted': "Salgylaryňyz pozuldy ",
          'delete_category': 'Kategoriýa poz',
          'delete_product': 'Haryt poz',
          'select_product': 'Haryt saýla',
          'delete': 'Poz'
        },
        'ru': {
          ...
          'start_view1': 'МЕНЮ',
          'start_view2': 'НАСТРОЙКИ',
          'start_view3': 'О НАС',
          'add_category': 'Добавить категорию',
          'add_product': 'Добавить товар',
          'add_category_first': 'Добавить категорию',
          ...
          'banner_added': "Баннер добавлен",
          'deleted': 'Удалено',
          'category_deleted': 'Категория удалена',
          'banner_deleted': "Баннер удален",
          'log_out_title': 'Вы уверены, что хотите выйти из системы?',
          'log_out_subtitle': 'Вы уверены, что хотите выйти из приложения?',
          'service_for': 'Для обслуживания:',
          'doYouWantToDeleteCart': 'Пустая корзина!',
          'doYouWantToDeleteCartSubtitle': 'Вы уверены, что хотите удалить корзину?',
        ...
        'en': {
          'start_view1': 'MENU',
          'start_view2': 'SETTINGS',
          'start_view3': 'ABOUT US',
          ...
          'log_out_title': 'Are you sure you want to log out?',
          'log_out_subtitle': 'Are you sure you want to exit the app?',
          'service_for': 'For service :',
          'doYouWantToDeleteCart': 'Empty Cart!',
          'doYouWantToDeleteCartSubtitle': 'Are you sure you want to delete the cart?',
